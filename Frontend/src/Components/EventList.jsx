...
const EventList = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl sm:text-4xl font-extrabold text-center mb-8 text-gray-800">Upcoming Events</h1>
        ...
        {filteredEvents.map(event => (
          ...
          >
            ...
            <div className="card-body p-4 sm:p-6">
              <h2 className="card-title text-xl sm:text-2xl font-semibold text-gray-900">{event.title}</h2>
              ...
              <div className="card-actions justify-end mt-4">
                <Link
                  to={`/event/${event._id}`}
                  className="btn bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-2 px-4 rounded-full hover:from-blue-600 hover:to-purple-700 transition duration-200 ease-in-out text-sm sm:text-base"
                >
                  View Details
                </Link>
              </div>
